## Inherent delusion
There is an inherent delusion built into language. When someone says, "I see you", the language presupposes an 'I', an act of seeing by that 'I', and a separate 'you' that is the object of seeing.
...
To do this, we are going to use the framework of the Buddha's teaching on *saḷāyatana*.
...
If you're familiar with Buddhist texts, *saḷāyatana* is one of those topics that is so frequently discussed in the suttas that one almost becomes immune to it. Hearing the words so often in theory, thinking you understand it, it is easy to gloss over it, and fail to look deeper into the topic experientially.
...
It is fine to elide these repetitious passages when going through the theory of the topic, but in meditation, one needs to carefully examine every aspect in detail. So, in this course, we are not going to be skipping over any *peyyāla* when the time comes to examine what the words are pointing at within our own experience.
## The five senses
First, some basics about sense experience, which might sound so simple that they don't need to be said. But let us build up our understanding of the senses from the ground upwards, not taking anything for granted.
...
So with that basic understanding in place, let us delve into the world of the senses.
...
What do you need to do to have an experience? Nothing, it is already happening. So turn your attention to what's already happening.
...
there is no need to create any special experience, merely know what is happening right now.

What is happening to you right now is completely personal and unpredictable. But what is certain is that it will be some sight, some sound, some smell, some taste, some physical sensation or some mental activity. These are really the only experiences that ever happen.
...
It can be quite relaxing just to pay attention to whatever is happening. there is no stress to do anything, just be relaxed, comfortable and know experiences as they come up.

Nothing is required other than some attention, some awareness of what is happening. All the rest happens quite naturally.

There is absolutely nothing to do. Just relax and know what's happening. That's the only job you have to do right now. It is great work if you can get it!
...
This world of the senses is the only world you've ever known. Everything that has ever happened in your life has happened right here. Everything that will ever happen, will happen right here. This is where it all happens.
